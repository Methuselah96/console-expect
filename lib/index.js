...
var MockConsole = /** @class */ (function () {
    ...
    MockConsole.prototype.allow = function (allowedMessage) {
        var _this = this;
        this.receivedMessages = this.receivedMessages
            .filter(function (receivedMessage) { return !_this.match(allowedMessage, receivedMessage); });
    ...
    MockConsole.prototype.messageReceived = function (messageInfo) {
        ...
        if (this.allowedMessages.some(function (allowedMessage) { return _this.match(allowedMessage, messageInfo); })) {
            return;
        }
    ...
    MockConsole.prototype.match = function (allowedMessage, receivedMessage) {
        if (allowedMessage.dev && process.env.NODE_ENV === "production")
            return false;
